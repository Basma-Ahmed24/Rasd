                    ...
                    child: SingleChildScrollView(
                      child: Form(key: formkey,
                        child: Column(children: [
                          ...
                          Text("${AppLocalizations.of(context)?.translate("addnews")}",
                          ...
                          Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.all(
                                      Radius.circular(10))
                              ), child: complainsTextFormField2("${AppLocalizations.of(context)?.translate("Newstitle")}", null, titlecontroller)),  SizedBox(
                            height: MediaQuery
                                .of(context)
                                .size
                                .height / 50,
                        ...
                        //  ),
                          ...
                          ElevatedButton(
                            ...
                            child:state is projnewsLoading
                                ...
                                :
                             Text(
                              "${AppLocalizations.of(context)?.translate("uploadn")}",
                              style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.w700,
                                  fontFamily: "Montserrat"),
  ...
  Widget complainsTextFormField2(String? hintText,IconData? locathion,TextEditingController cont) {
    return TextFormField(
      ...
      validator: (value) {
        ...
        }  if (hintText.trim() =="${AppLocalizations.of(context)?.translate("location")}") {
          if (value!.isEmpty) {
            return "address must not be empty";
          }

        }
        if (hintText!.trim() == "${AppLocalizations.of(context)?.translate("startdate")}") {
          if (value!.isEmpty) {
            return "Date must not be empty";
          }}

        if (hintText!.trim() == "${AppLocalizations.of(context)?.translate("Newstitle")}") {
          if (value!.isEmpty) {
      ...
      decoration: InputDecoration(
        ...
        hintText: hintText,
        suffixIcon: hintText == "${AppLocalizations.of(context)?.translate("enddate")}"||hintText == "${AppLocalizations.of(context)?.translate("startdate")}" ?
        InkWell(
          onTap: () async {
