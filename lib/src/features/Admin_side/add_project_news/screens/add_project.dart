        ...
        child: BlocConsumer<ProjNewsCubit, ProjNewsState>(
          ...
          if (state is projnewsLoaded) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                  content: Text(
                      "${AppLocalizations.of(context)?.translate("failerp")}")),
            );
          }
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                            "${AppLocalizations.of(context)?.translate("add Project")}",
                        ...
                        Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                borderRadius:
                                    BorderRadius.all(Radius.circular(10))),
                            child: complainsTextFormField2(
                                "${AppLocalizations.of(context)?.translate("projecttitle")}",
                                null,
                                titlecontroller)),
                        SizedBox(
                          height: MediaQuery.of(context).size.height / 50,
                        ...
                        Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                borderRadius:
                                    BorderRadius.all(Radius.circular(10))),
                            child: complainsTextFormField2(
                                "${AppLocalizations.of(context)?.translate("organization")}",
                                null,
