...
class _SettingsState extends State<Settings> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (BuildContext context) {
          c..getUserData(CacheHelper.getData(key: "apiToken"));
  ...
  Future<void> _pickImage(BuildContext context) async {
    ...
    if (result != null) {
      ...
      await c.uploadImage(result);
      print(c.path1);
      await c.updateUserImage(CacheHelper.getData(key: "apiToken"), c.path1);
      list1["profile_img"]=c.path1;
